...
class BreakfastActivity : AppCompatActivity(), BreakfastAdapter.OrderClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        database = FirebaseDatabase.getInstance().reference.child("food_item").child("breakfast")
